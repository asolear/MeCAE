...
const TermsOfUse = () => {
  return (
    <div style={containerStyle}>
      ...
      <h2>4. Autorización para Ofertar Ahorros Energéticos</h2>
      <p>
        Al utilizar esta plataforma, el propietario de los ahorros energéticos autoriza expresamente a MeCAE a ofertar, exhibir y promocionar sus productos a través del sitio. Esta autorización incluye el derecho de MeCAE a utilizar imágenes, descripciones y cualquier otro contenido proporcionado por el propietario para la promoción de los ahorros energéticos. El propietario garantiza que tiene todos los derechos necesarios para otorgar esta autorización.
      </p>

      <h2>5. Veracidad de la Información Proporcionada</h2>
      <p>
